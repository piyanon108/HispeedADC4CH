...
--               /home/ubuntu/fpgaProject/MyIR7020/Vivado2022.2/HispeedADC4CH/HispeedADC4CH.gen/sources_1/bd/design_1/ip/design_1_util_ds_buf_2_2/design_1_util_ds_buf_2_2_sim_netlist.vhdl
...
entity design_1_util_ds_buf_2_2_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_1_util_ds_buf_2_2_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_1_util_ds_buf_2_2_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_1_util_ds_buf_2_2_util_ds_buf : entity is "OBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of design_1_util_ds_buf_2_2_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of design_1_util_ds_buf_2_2_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of design_1_util_ds_buf_2_2_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_1_util_ds_buf_2_2_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_1_util_ds_buf_2_2_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_util_ds_buf_2_2_util_ds_buf : entity is "util_ds_buf";
end design_1_util_ds_buf_2_2_util_ds_buf;

architecture STRUCTURE of design_1_util_ds_buf_2_2_util_ds_buf is
...
entity design_1_util_ds_buf_2_2 is
  ...
  attribute NotValidForBitStream of design_1_util_ds_buf_2_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_util_ds_buf_2_2 : entity is "design_1_util_ds_buf_2_2,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_util_ds_buf_2_2 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_util_ds_buf_2_2 : entity is "util_ds_buf,Vivado 2022.2";
end design_1_util_ds_buf_2_2;

architecture STRUCTURE of design_1_util_ds_buf_2_2 is
...
begin
U0: entity work.design_1_util_ds_buf_2_2_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
