...
module design_1_wrapper
  ...
  input adc_CLKOUT_0;
  input adc_SDO1_0;
  output [0:0]clock_gate_clk_n;
  output [0:0]clock_gate_clk_p;
  output [0:0]cnv_clk_n;
  output [0:0]cnv_clk_p;
  ...
  wire adc_CLKOUT_0;
  wire adc_SDO1_0;
  wire [0:0]clock_gate_clk_n;
  wire [0:0]clock_gate_clk_p;
  wire [0:0]cnv_clk_n;
  wire [0:0]cnv_clk_p;
  ...
  design_1 design_1_i
       (.CLK_IN_D_0_clk_n(CLK_IN_D_0_clk_n),
        ...
        .clock_gate_clk_n(clock_gate_clk_n),
        .clock_gate_clk_p(clock_gate_clk_p),
        .cnv_clk_n(cnv_clk_n),
        .cnv_clk_p(cnv_clk_p),
